 ...
 *
 * @param filePath
 * @param parameters - extra parameters like '--step'.
 ...
 * @param callback
 */
RRDTool.prototype.create = function (filePath, ds, rra, parameters, callback) {

  var args = ['create', filePath].concat(parameters).concat(ds).concat(rra);
console.log("args = "+args);
  this._rrdExec(args
    , callback
    , function (data) {
